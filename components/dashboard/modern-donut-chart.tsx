...
export default function ModernDonutChart() {
  const data = [
    { name: "Marketing", value: 25, color: "#ec4899", amount: "$11,039.00" },
    { name: "Location Bureau", value: 17, color: "#8b5cf6", amount: "$7,500.00" },
    { name: "Publicité", value: 14, color: "#06b6d4", amount: "$6,200.00" },
    { name: "Assurance", value: 10, color: "#84cc16", amount: "$4,400.00" },
    { name: "Fournitures", value: 5, color: "#f59e0b", amount: "$2,200.00" },
  ]
      ...
      <CardHeader className="pb-4">
        <div className="flex items-center justify-between">
          ...
          <Select defaultValue="top5">
            <SelectTrigger className="w-32 text-sm border-slate-200">
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
