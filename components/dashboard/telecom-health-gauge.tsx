...
export default function TelecomHealthGauge() {
    ...
    <Card className="bg-white border-0 shadow-soft hover:shadow-medium transition-all duration-300">
      <CardHeader className="pb-4">
        <div className="flex items-center justify-between">
          ...
          <div className="text-xs text-slate-500 bg-slate-50 px-2 py-1 rounded-lg">Mis à jour il y a 1h</div>
        </div>
      </CardHeader>
      <CardContent className="flex flex-col items-center">
        ...
        <div className="text-center">
          ...
          <p className="text-xs text-slate-500 mt-1">Système en bon état général</p>
        </div>
      </CardContent>
    </Card>
  )
